...
echo "atram.py --blast-db=/scratch/brown/ycrane/SRR9125476_htsclepurrenrefforatram2 --query=Zeaisocitratedehydrogenases.fasta --assembler=spades --output-prefix=/scratch/brown/ycrane/atramout/Stanleyisocitratedehydrogenasesbyatram2 --iterations=21 --protein --cpus=10 --log-file=Stanleyisocitratedehydrogenasesbyatram2log.txt --temp-dir=/scratch/brown/ycrane/atramtemp --timeout=100000 --no-filter --evalue=1e-10 --max-memory=95"
date
