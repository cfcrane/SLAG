...
open (OUT, "> $ARGV[2]"); #ZeaferredoxinsSRcap3subsetcontigseries.txt
$rscript = $ARGV[3]; #ZeaferredoxinsSRcap3graphics.R
$pdffile = $ARGV[4]; #ZeaferredoxinsSRcap3graph.pdf
$pdfheight = $ARGV[5]; #3
$pdfwidth = $ARGV[6]; #4
...
print RSC "plot(x, rmatchinglengths, ylim = c(0, $ubound), type = \"l\", xlab = \"Cycle\", ylab = \"Length\", lty = 2)\n";
print RSC "lines(x, ralllengths, lty = 1)\npar(new = TRUE)\n";
...
print RSC "plot(x, rallcontigs, ylim = c($lowbound, $highbound), type = \"l\", xlab = \"\", ylab = \"\", xaxt = \"n\", yaxt = \"n\", lty = 3)\n";
