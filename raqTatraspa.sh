...
echo "atram.py --blast-db=/scratch/brown/ycrane/quartSRR9125476_htsclepurrenrefforatram2 --query=Zeatransaminases.fasta --assembler=spades --output-prefix=/scratch/brown/ycrane/atramout/quartStanleytransaminasesbyatram2 --iterations=21 --protein --cpus=10 --log-file=quartStanleytransaminasesbyatram2log.txt --temp-dir=/scratch/brown/ycrane/atramtemp --timeout=100000 --no-filter --evalue=1e-10 --max-memory=95"
date
