...
echo "atram.py --blast-db=/scratch/brown/ycrane/ERR328821xcleanedforatram2 --query=Zeatransaminases.fasta --assembler=spades --output-prefix=/scratch/brown/ycrane/atramout/Zeatransaminasesbyatram2 --iterations=21 --protein --cpus=10 --log-file=Zeatransaminasesbyatram2log.txt --temp-dir=/scratch/brown/ycrane/atramtemp --timeout=100000 --no-filter --evalue=1e-10 --max-memory=95"
date
