...
echo "atram.py --blast-db=/scratch/brown/ycrane/hemiSRR9125476_htsclepurrenrefforatram2 --query=Zeahexokinases.fasta --assembler=spades --output-prefix=/scratch/brown/ycrane/atramout/hemiStanleyhexokinasesbyatram2 --iterations=21 --protein --cpus=10 --log-file=hemiStanleyhexokinasesbyatram2log.txt --temp-dir=/scratch/brown/ycrane/atramtemp --timeout=100000 --no-filter --evalue=1e-10 --max-memory=95"
date
