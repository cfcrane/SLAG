...
echo "atram.py --blast-db=/scratch/brown/ycrane/ERR328821xcleanedforatram2 --query=Zeacellulosesynthases.fasta --assembler=spades --output-prefix=/scratch/brown/ycrane/atramout/Zeacellulosesynthasesbyatram2 --iterations=21 --protein --cpus=10 --log-file=Zeacellulosesynthasesbyatram2log.txt --temp-dir=/scratch/brown/ycrane/atramtemp --timeout=100000 --no-filter --evalue=1e-10 --max-memory=95"
date
